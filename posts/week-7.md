...
<script type="module">
  ...
  class Particle {
    ...
    update() {
      ...
      this.y += this.vy;
      if (this.x > this.effect.height - this.radius || this.y < this.radius)
        this.vy *= -1;
    }
...
By combining ideas, and libraries can create more layers to the chaotic effect that can result in complexity and it's effective because it achieves the goal of being chaotic...
